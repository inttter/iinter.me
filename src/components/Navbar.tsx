...
function Navbar() {
    ...
    return (
        <div className="absolute top-10">
            ...
            <div
                className={`${isOpen ? 'block' : 'hidden'} bg-neutral-900 backdrop-blur-sm p-4 my-2 rounded-md shadow-2xl shadow-neutral-900 z-10 border border-neutral-800 animate-blurred-fade-in duration-300`}
            >
